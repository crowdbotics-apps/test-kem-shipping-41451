"""
Django settings for test_kem_shipping_41451 project.
...
ROOT_URLCONF = 'test_kem_shipping_41451.urls'
...
WSGI_APPLICATION = 'test_kem_shipping_41451.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_kem_shipping_41451 API",
    "DESCRIPTION": "API documentation for test_kem_shipping_41451 App",
    "VERSION": "v1",
}
